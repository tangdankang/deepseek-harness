...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/host/apiproxy-stdio': { kind: 'none', reason: 'The stdio carrier moves already-composed Host API messages and registers nothing model-facing.' },
  ...
  'packages/bundle/vscode-app': { kind: 'indirect', reason: 'The bundle only mounts host-side rows over dsh-base; each base row owns its model-facing behavior.' },
